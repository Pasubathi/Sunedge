...
import BRAND from './Stacks/Brand'

import MOSTLIKED from './Stacks/Newest'
import DEALS from './Stacks/Newest'
import NEWEST from './Stacks/Newest'
import TOPSELLER from './Stacks/Newest'
import EDITPROFILE from './Stacks/MyAccount'
import PROFILE from './Stacks/MyProfile'
import TRAINING from './Stacks/MyTraining'
import SIGNUP from './Stacks/SignUp'
import NETWORK from './Stacks/Network'
import VOUCHERS from './Stacks/Vouchers'
import BIRTHDAY from './Stacks/Birthday'
import SCHEMES from './Stacks/Schemes'
import BONUS from './Stacks/Bonus'
...
console.log('auth gustLogin =======>',SyncStorage.get('gustLogin'))
console.log('auth customerData =======>',SyncStorage.get('customerData'))
...
export default createAppContainer(
  createSwitchNavigator({
    AuthLoading: (SyncStorage.get('gustLogin') || SyncStorage.get('customerData') == '')?LOGIN:HOME,
    App: (SyncStorage.get('gustLogin') || SyncStorage.get('customerData') == '')?AuthDrawer:AppDrawer
  })
)
