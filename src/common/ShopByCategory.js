        ...
        <View style={styles.scrollArea}>
          ...
          >
                <View style={styles.rectRow}>
                 {this.state.catArray.map( catItem => 
                    <TouchableOpacity  >
                      <View style={styles.rect}>
                        <Text style={styles.myNetwork}>{catItem.categories_name}</Text>
                        <Image
                          source={{ uri:themeStyle.assetUrl+catItem.image }}
                          resizeMode="contain"
                          style={styles.image}
                        ></Image>
                      </View>
...
export default connect(mapStateToProps, null)(ShopByCategory)
